...
from transformers import BertTokenizer, AutoTokenizer, RoFormerTokenizer, BertModel, AutoModel, AutoModelForMaskedLM, AutoModelWithLMHead, \
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='regression_roformer_fgm', type=str)
