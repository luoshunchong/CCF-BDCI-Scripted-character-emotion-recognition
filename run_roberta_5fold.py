...
class BERTClass(torch.nn.Module):
    ...
    def __init__(self,roberta_path):
        ...
        self.bert = AutoModel.from_pretrained(roberta_path)
...
def model_train(args, train_df,tokenizer):
    ...
    for i, (trn_idx, val_idx) in enumerate(skf.split(train_df["text"], train_df["label_new"])):
        ...
        model=BERTClass(args.roberta_path)
...
def model_predict(args, test, submit,tokenizer):
    ...
    test_model = BERTClass(args.roberta_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='run_roberta_5fold', type=str)
