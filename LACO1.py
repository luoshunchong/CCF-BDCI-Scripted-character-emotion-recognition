...
class convert_input(object):
    ...
    def convert_inputs(self, text, max_seq_length, is_dev, target=None):
...
class BERTDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # )
        if not self.is_dev:
            inputs = self.tokenizer.convert_inputs(text, self.max_len, self.is_dev, self.targets[index])
        else:
            inputs = self.tokenizer.convert_inputs(text, self.max_len, self.is_dev)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='robert', type=str)
    parser.add_argument('--data_path', default='../input/scer-contest/raw_data/', type=str)
    parser.add_argument('--bert_path', default='../input/crobertawwmext/chinese-roberta-wwm-ext/', type=str)
