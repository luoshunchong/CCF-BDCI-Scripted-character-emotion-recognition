...
class BERTClass(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        # bigru
        self.BiGRU = nn.GRU(768, args.hidden_size, args.num_layers, bidirectional=True,
                            batch_first=True,
                            dropout=args.dropout)
        self.fc = nn.Linear(102400, args.num_classes)

    def forward(self, ids, mask, token_type_ids):
        features, _ = self.bert(input_ids=ids, attention_mask=mask, token_type_ids=token_type_ids, return_dict=False)
