...
from transformers import BertTokenizer, AutoTokenizer, BertModel, AutoModel, get_linear_schedule_with_warmup, AdamW, get_cosine_schedule_with_warmup
...
# from chineseBERT.modeling_glycebert import GlyceBertModel
...
class BERTClass(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        config = ChineseBertConfig.from_pretrained(args.berta_token_path)
        self.bert = ChineseBertForMaskedLM.from_pretrained(args.roberta_path, config=config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='regression_chineseBERT_fgm_fold_ensemble', type=str)
    parser.add_argument('--data_path', default='./raw_data/', type=str)
    parser.add_argument('--roberta_path', default='./pre_models/ShannonAI_ChineseBERT-base/', type=str)
    parser.add_argument('--berta_token_path', default='./pre_models/junnyu_ChineseBERT-base-token/', type=str)
    ...
    tokenizer = ChineseBertTokenizerFast.from_pretrained(args.berta_token_path)
