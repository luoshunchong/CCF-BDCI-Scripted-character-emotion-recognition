...
from transformers import BertTokenizer, AutoTokenizer, RoFormerTokenizer, XLNetModel, BertModel, AutoModel, AutoModelForMaskedLM, get_linear_schedule_with_warmup, AdamW
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='regression_robert_fgm', type=str)
    parser.add_argument('--data_path', default='./raw_data/', type=str)
    parser.add_argument('--roberta_path', default='./pre_models/chinese-xlnet-base/', type=str)
