...
"""
0.7016regression_robert_fgm.tsv：早停，学习率的调整warmup_50,fgm,加上了剧本id,将长度小于50的句子拼接前3句,将每句长度设置为100
0.7019regression_robert_fgm.tsv：早停，学习率的调整warmup_50,fgm,加上了剧本id,将长度小于50的句子拼接前3句,将每句长度设置为110
0.7023regression_robert_fgm.tsv:早停，梯度裁剪_2,学习率的调整warmup_50,fgm,加上了剧本id,将长度小于50的句子拼接前3句,将每句长度设置为110
* 0.7026regression_robert_fgm.tsv:早停，梯度裁剪_2,学习率的调整warmup_50,fgm,加上了剧本id,将长度小于70的句子拼接前3句,将每句长度设置为110
"""