...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='regression_mengzi_fgm_fold_ensemble', type=str)
    parser.add_argument('--data_path', default='./raw_data/', type=str)
    parser.add_argument('--roberta_path', default='./pre_models/Langboat_mengzi-bert-base/', type=str)
