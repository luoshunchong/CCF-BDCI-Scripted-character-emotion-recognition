...
from transformers import BertTokenizer, AutoTokenizer, BertModel, AutoModel, AutoModelForMaskedLM, AutoModelWithLMHead, \
    get_linear_schedule_with_warmup, AdamW, get_cosine_schedule_with_warmup
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='regression_electra_fgm', type=str)
    parser.add_argument('--data_path', default='./raw_data/', type=str)
    parser.add_argument('--roberta_path', default='./pre_models/chinese-electra-180g-base-discriminator/', type=str)
